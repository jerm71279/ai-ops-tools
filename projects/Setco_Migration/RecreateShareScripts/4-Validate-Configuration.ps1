...
$expectedShares = @(
    ...
    @{Name="Legal"; Path="E:\HomeDirs\Legal"},
    @{Name="PostClosing"; Path="E:\PostClosing"},
    @{Name="Qbooks"; Path="E:\Qbooks"},
    @{Name="SeaCrestScans"; Path="E:\SeaCrestScans"},
    @{Name="SetcoDocs"; Path="E:\SetcoDocs"},
    @{Name="Versacheck"; Path="E:\Versacheck"},
    @{Name="Whole Life Fitness"; Path="E:\Whole Life Fitness"},
    @{Name="worddocs"; Path="E:\NTSYS\worddocs"}
)
