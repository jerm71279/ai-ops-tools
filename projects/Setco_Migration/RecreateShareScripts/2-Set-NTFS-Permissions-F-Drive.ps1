...
Write-Host "Configuring NTFS Permissions on F:\ drive..." -ForegroundColor Cyan
...
# ============================================================================
# F:\ ROOT DRIVE PERMISSIONS
# ============================================================================
Write-Host "`n--- Configuring F:\ ---" -ForegroundColor Cyan
Set-NTFSPermissionsFromSDDL -Path "F:\" `
...
# FTP DATA
# ============================================================================
Write-Host "`n--- Configuring F:\FTP Data ---" -ForegroundColor Cyan
Set-NTFSPermissionsFromSDDL -Path "F:\FTP Data" `
...
# HOMEDIRS
# ============================================================================
Write-Host "`n--- Configuring F:\HomeDirs ---" -ForegroundColor Cyan
Set-NTFSPermissionsFromSDDL -Path "F:\HomeDirs" `
...
# HOMEDIRS\LEGAL
# ============================================================================
Write-Host "`n--- Configuring F:\HomeDirs\Legal ---" -ForegroundColor Cyan
Set-NTFSPermissionsFromSDDL -Path "F:\HomeDirs\Legal" `
...
# POSTCLOSING
# ============================================================================
Write-Host "`n--- Configuring F:\PostClosing ---" -ForegroundColor Cyan
Set-NTFSPermissionsFromSDDL -Path "F:\PostClosing" `
...
# QBOOKS
# ============================================================================
Write-Host "`n--- Configuring F:\Qbooks ---" -ForegroundColor Cyan
Set-NTFSPermissionsFromSDDL -Path "F:\Qbooks" `
...
# SEACRESTSCANS
# ============================================================================
Write-Host "`n--- Configuring F:\SeaCrestScans ---" -ForegroundColor Cyan
Set-NTFSPermissionsFromSDDL -Path "F:\SeaCrestScans" `
...
# SETCODOCS
# ============================================================================
Write-Host "`n--- Configuring F:\SetcoDocs ---" -ForegroundColor Cyan
Set-NTFSPermissionsFromSDDL -Path "F:\SetcoDocs" `
...
# VERSACHECK
# ============================================================================
Write-Host "`n--- Configuring F:\Versacheck ---" -ForegroundColor Cyan
Set-NTFSPermissionsFromSDDL -Path "F:\Versacheck" `
...
# WHOLE LIFE FITNESS
# ============================================================================
Write-Host "`n--- Configuring F:\Whole Life Fitness ---" -ForegroundColor Cyan
Set-NTFSPermissionsFromSDDL -Path "F:\Whole Life Fitness" `
...
# WORDDOCS
# ============================================================================
Write-Host "`n--- Configuring F:\NTSYS\worddocs ---" -ForegroundColor Cyan
Set-NTFSPermissionsFromSDDL -Path "F:\NTSYS\worddocs" `
